...
from PyQt5.QtGui import QPixmap, QIcon, QPainter, QPaintEvent, QBrush
from PyQt5.QtWidgets import QWidget, QLabel, QApplication, QAction, QMainWindow
...
class SimMoveDemo(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setStyleSheet("QWidget {background-image: url(sea.jpg)}")
